      ...
      <div className="bg-white/95 dark:bg-[#0D0D15]/90 backdrop-blur-2xl border border-slate-200/60 dark:border-[#1F1F35] max-w-sm w-full p-6 rounded-none shadow-[0_20px_50px_rgba(112,0,255,0.12)] relative transition-all duration-300 text-xs text-left">
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:gap-3">
          <button
            type="button"
            onClick={onCancel}
            className="flex-1 py-2.5 rounded-none text-xs font-bold bg-slate-100 hover:bg-slate-200 dark:bg-[#151522]/55 dark:hover:bg-[#1C1C30]/55 text-slate-700 dark:text-slate-350 border border-slate-200/40 dark:border-[#2A2A40] transition-colors"
          >
            {cancelLabel}
          </button>
          {onThirdOption && thirdOptionLabel && (
            <button
              ...
              className="flex-1 py-2.5 rounded-none text-xs font-bold bg-rose-600/15 hover:bg-rose-600/25 text-rose-600 dark:text-rose-450 border border-rose-500/25 transition-colors"
            >
              {thirdOptionLabel}
            </button>
          )}
          <button
            ...
            className="flex-1 py-2.5 rounded-none text-xs font-bold bg-rose-600 hover:bg-rose-700 text-white shadow-[0_4px_12px_rgba(225,29,72,0.2)] transition-colors"
          >
            {confirmLabel}
          </button>
        </div>
