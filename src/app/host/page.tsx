      ...
      <header className="border-b border-border bg-card sticky top-0 z-50 transition-colors shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-lg bg-primary flex items-center justify-center font-bold text-white text-lg shadow-sm shadow-primary/15 transition-transform hover:scale-105 select-none">
              H
            </div>
